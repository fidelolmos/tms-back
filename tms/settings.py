...
# Permitir CORS desde el frontend (React, Vue, etc.)
CORS_ALLOWED_ORIGINS = os.getenv('CORS_ALLOWED_ORIGINS', '').split(',')  # Cambiar a False en producción y definir CORS_ALLOWED_ORIGINS
